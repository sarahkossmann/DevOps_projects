...
class TestScanString(TestCase):
    ...
    def test_issue3623(self):
        self.assertRaises(ValueError, simplejson.decoder.scanstring, "xxx", 1,
                          "xxx")
        self.assertRaises(UnicodeDecodeError,
                          simplejson.encoder.encode_basestring_ascii, b("xx\xff"))
    ...
    def test_overflow(self):
        ...
        self.assertRaises(OverflowError, simplejson.decoder.scanstring, "xxx",
                          maxsize + 1)
